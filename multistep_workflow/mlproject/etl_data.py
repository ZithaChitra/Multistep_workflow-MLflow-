...
@click.command(
	help="Given a CSV file (see load_raw_data), transforms it into Parquet in an mlflow artifact called 'ratings-parquet-dir'"
)
@click.option("--ratings-csv")
@click.option(
	"--max-row-limit", default=10000, help="Llimit the data size to run comfortably on a laptop."
)
